...
Part of <a href="#" onclick="window.open('http://metabolismofcities.org/')">Metabolism of Cities</a>, <a href="#" onclick="window.open('https://ofora.org/')">O Fora</a> and <a href="#" onclick="window.open('http://hardcoredistancelearning.com/')">Online Doctorate</a>.
